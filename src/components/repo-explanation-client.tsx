...
import { AlertTriangle, ExternalLink, Star, GitBranch, Users, Code, Calendar, Sparkles, Loader2, Brain, Target, RefreshCw, Bookmark, BookmarkCheck } from 'lucide-react';
    ...
    const handleAnalyzeRepository = async () => {
        ...
        try {
            ...
            console.log('Analysis completed. Result structure:', {
                ...
                componentMappingLength: result.componentMapping?.length
            });
